...
OBJS = ./prngs/LSBState.o ./prngs/GlibcRand.o ./prngs/PHP_mt19937.o ./prngs/WPRand.o \
		./prngs/Mt19937.o ./prngs/Ruby.o ./prngs/crypto/md5.o ./prngs/crypto/sha1.o \
		./prngs/PRNGFactory.o ./Untwister.o

TEST_OBJS = ./tests/runner.o ./tests/TestRuby.o ./tests/TestMt19937.o ./tests/TestPRNGFactory.o \
			 ./tests/Test_PHP_mt19937.o ./tests/TestUntwister.o

all: GlibcRand Mt19937 PHP_mt19937 WPRand Ruby LSBState PRNGFactory Crypto Untwister
	$(CC) $(CPPFLAGS) -pthread -MF"main.d" -MT"main.d" -o "main.o" "./main.cpp"
	$(CC) -std=gnu++11 -O3 -pthread $(OBJS) main.o -o untwister

python: GlibcRand Mt19937 PHP_mt19937 WPRand Ruby LSBState PRNGFactory Crypto Untwister
...
tests: GlibcRand Mt19937 PHP_mt19937 WPRand Ruby LSBState PRNGFactory Crypto Untwister
